...
ts <- tradeStatsExt("forex","GBPUSD", Dates = "2002-10-22::2002-10-30")
...
checkEquals( ts$Net.Trading.PL             , -532 )
...
checkEquals( ts$Percent.Time.In.Market     , 80.952380952380949 )
checkEquals( ts$RINA.Index                 , -0.91709991492573573 )
